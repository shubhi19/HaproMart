...
{
    public partial class beverage_snacks : Form
    {
        ...
        string emailid = "";
        string cart = "";
        public beverage_snacks(string email, string pinno)
        {
            InitializeComponent();
            label12.Text = email;
            label13.Text = pinno;
        ...
        private void button2_Click(object sender, EventArgs e)
        {
            ...
            connect1();
                ...
                conn.Close();
                Form5 f5 = new Form5(user, pinno, name, qty_final, final); // creates a new object for Form 2.
        ...
        private void beverage_snacks_Load(object sender, EventArgs e)
        {
        ...
        private void deleteAccountToolStripMenuItem_Click_1(object sender, EventArgs e)
        {
            delete de = new delete(); // creates a new object for Form 2.
            de.Show(); // Projecting the second form.
            this.Hide(); // Hides the Form 1 but doesn’t close.
